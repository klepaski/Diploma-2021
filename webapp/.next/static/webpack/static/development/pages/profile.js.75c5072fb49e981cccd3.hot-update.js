...
var UserContent = function UserContent(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_Profile_styledUser__WEBPACK_IMPORTED_MODULE_19__["Wallpaper"], {
    ...
    fz: 14,
    mt: 15
  }, user.education), __jsx(_components_StyledComponents_Text__WEBPACK_IMPORTED_MODULE_12__["Text"], {
    bold: true,
    fz: 18
    ...
    fz: 18,
    mb: 30
  }, "".concat(user.firstName || '', " ").concat(user.lastName || ''), " provided"), __jsx(_components_Layouts_styledLayouts__WEBPACK_IMPORTED_MODULE_4__["CheckLabel"], {
    grbl: true,
    label: "Email address"
...
//# sourceMappingURL=profile.js.75c5072fb49e981cccd3.hot-update.js.map